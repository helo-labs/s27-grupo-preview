        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-pure border border-navy/10 p-6 rounded-lg shadow-xl">
              <div className="flex flex-wrap gap-x-5 gap-y-2 border-b border-offwh/80 mb-6">
                {(['missao', 'valores', 'frota'] as Tab[]).map(t => {
                  ...
                  return (
                    <button key={t} onClick={() => setTab(t)}
                      className={`pb-2 -mb-px font-display font-bold text-sm transition-all border-b-2 ${tab === t ? 'text-orange border-orange' : 'text-gray-500 border-transparent hover:text-navy'}`}>
                      {labels[t]}
                    </button>
                  );
                })}
