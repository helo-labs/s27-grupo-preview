        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {services.map((svc, i) => (
            <button key={svc.id}
              ...
              className="group bg-pure p-8 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-between transform hover:-translate-y-2 cursor-pointer text-left border border-navy/5 border-t-4 border-t-navy">
              <div>
